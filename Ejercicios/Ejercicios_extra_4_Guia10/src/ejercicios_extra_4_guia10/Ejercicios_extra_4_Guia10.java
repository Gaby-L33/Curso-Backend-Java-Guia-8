package ejercicios_extra_4_guia10;

import java.util.HashMap;
import java.util.Scanner;
import servicio.ServicioPostales;

public class Ejercicios_extra_4_Guia10 {
    ...
    public static void main(String[] args) {
        ...
        ServicioPostales postalesService = new ServicioPostales();
